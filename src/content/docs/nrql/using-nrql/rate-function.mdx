...
<CollapserGroup>
  ...
  >
    If you want to view errors by application, you can `FACET` by `appName`. This example shows how you can identify the average errors by application over the past 30 minutes:
